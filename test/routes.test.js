...
function serviceStub() {
  return {
    ...
    status: () => ({ connected: false, socketOpen: false, tickerSymbols: ['BTCUSD_PERPETUAL', 'ETHUSD_PERPETUAL'], exchangeCandlestickStreamInterval: '1m', maxCandlesInMemory: 1000, candles: { btcusd: 1, ethusd: 1 } }),
